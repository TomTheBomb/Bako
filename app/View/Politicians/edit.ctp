...
<?php echo $this->Form->create('Politician'); ?>
	<fieldset>
		<legend><?php echo __('Edit Politician'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Politician.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Politician.id'))); ?></li>
